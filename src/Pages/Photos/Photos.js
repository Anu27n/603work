...
const Photos = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="body-2 heroText">Visit Our Gallery</h1>
        <img
      ...
      <section id="spaces" className="section service bg-black-10 text-center" aria-label="service">
        <div className="container">
          <p className="section-subtitle label-2">Our Gallery</p>
          <h2 className="headline-1 section-title title-box" style={{ marginBottom: "10rem" }}>
            Discover Our Recent Highlights{" "}
          </h2>
                ...
                <div className="service-card">
                  <a onClick={() => handleCardClick(blog.id)} className="has-before hover:shine">
                    <figure className="card-banner img-holder" style={{ "--width": 285, "--height": 336 }}>
                      <img src={blog.image} width="285" height="336" loading="lazy" alt={blog.title} className="img-cover" />
                    </figure>
                  </a>
